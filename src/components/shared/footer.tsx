...
const Footer = () => {
  return (
    <footer className="relative max-w-full w-full h-[100vh] overflow-hidden z-[20] pb-14 lg:pb-0">
      ...
      <div className="mt-[86px] z-[10] absolute px-4 flex flex-col gap-[2.3rem] w-full h-full">
        <h1 className="uppercase text-left lg:text-right lg:ml-[644px] font-BiggerDisplay font-bold text-[99px] max-w-[225px] lg:text-[162px] leading-[88px] lg:leading-[164px] text-white lg:max-w-[840px] w-full">
          let&apos;s bring your ideas to life
        </h1>
        <button className="lg:ml-[39rem] max-w-[350px] lg:max-w-[428px] w-full h-[72px] rounded-full p-0 flex items-center justify-center border border-white/20 group transition-all duration-300 hover:bg-[rgb(254,61,0)] ">
        ...
        <div className="block lg:hidden pb-[10rem]">
          <FooterMobile />
        </div>
      </div>
    </footer>
          ...
          <div className="items-center flex flex-none flex-row flex-nowrap gap-0 h-min justify-center overflow-visible p-0 relative w-[76%]">
            <div className="items-start flex flex-none flex-col flex-nowrap gap-12 h-min justify-start overflow-visible p-0 relative w-[40%]">
              ...
              <div className="items-start flex flex-none flex-col flex-nowrap gap-2 h-min justify-start overflow-visible p-0 relative w-full">
                ...
                <div className="border-camera-bottom" data-border="true"></div>
              </div>
            </div>
...
function FooterMobile() {
  return (
    <>
      <div className="mb-9 flex flex-col  w-full">
        <div className="flex flex-row items-end justify-between w-full">
          <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-1">
              <span className="text-sm font-normal text-[#999]">(Contact)</span>
              <h6 className="text-lg font-normal text-[#dfdfdf]">
                hello@nikistudio.com
              </h6>
              <h6 className="text-lg font-normal text-[#dfdfdf]">
                +84 378 583 296
            ...
            <div className="flex flex-col gap-1">
              ...
              <span className="text-lg font-normal text-[#dfdfdf]">
                24 De La Thanh Street, Dong Da
              </span>
              <span className="text-lg font-normal text-[#dfdfdf]">
            ...
            <div className="flex-col flex gap-1">
              ...
              <ul className="flex flex-col list-disc pl-4">
                <li>
                  <Link href="https://www.instagram.com/darrysduc_/">
                    <span className="text-sm font-normal text-[#dfdfdf]">
                      Instagram
                    </span>
                  </Link>
                </li>
          ...
          <Link
            href="#"
            className="flex items-center justify-center size-16 border border-white/20 text-white rounded-full relative overflow-hidden group transition-all duration-300 bg-transparent hover:bg-[rgb(254,61,0)]"
          >
            <span className="absolute inset-0 flex items-center justify-center transform translate-y-0 opacity-100 group-hover:-translate-y-6 group-hover:opacity-0 transition-all duration-300">
              <ArrowUp size={26} />
            </span>
